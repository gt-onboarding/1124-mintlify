...
description: "Passen Sie Ihre Dokumentation mit eigenem CSS und JS vollständig an"
icon: "code"
---

Verwenden Sie CSS, um HTML-Elemente zu stylen, oder fügen Sie eigenes CSS und JavaScript hinzu, um Look & Feel Ihrer Dokumentation vollständig anzupassen.

<div id="styling-with-tailwind-css">
  ## Styling mit Tailwind CSS
</div>

Verwenden Sie Tailwind CSS v3, um HTML-Elemente zu gestalten. Sie können Layout, Abstände, Farben und weitere visuelle Eigenschaften steuern. Häufig verwendete Klassen sind:
...
<div id="using-identifiers-and-selectors">
  ### Verwenden von Identifikatoren und Selektoren
</div>
...
<Tip>
  Verwenden Sie „Element untersuchen“, um Referenzen zu den Elementen zu finden, die Sie anpassen möchten.
</Tip>
...
<Warning>
  Verweise und das Styling gängiger Elemente können sich mit der Weiterentwicklung der Plattform ändern. Bitte verwenden Sie benutzerdefiniertes Styling mit Vorsicht.
</Warning>
...
Mit benutzerdefiniertem JS können Sie global eigenen ausführbaren Code hinzufügen. Das entspricht dem Einfügen eines `<script>`-Tags mit JS-Code auf jede Seite.

<div id="adding-custom-javascript">
  ### Hinzufügen von benutzerdefiniertem JavaScript
</div>

Jede `.js`-Datei im Content-Verzeichnis Ihrer Dokumentation wird auf jeder Dokumentationsseite eingebunden. Sie können beispielsweise die folgende Datei `ga.js` hinzufügen, um [Analytics](https://marketingplatform.google.com/about/analytics) in der gesamten Dokumentation zu aktivieren.
...
<Warning>
  Bitte vorsichtig verwenden, um keine Sicherheitslücken zu verursachen.
</Warning>
