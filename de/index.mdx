---
title: "Einführung"
description: "Lernen Sie die nächste Generation der Dokumentation kennen: KI-native, sofort einsatzbereit und für Entwickler entwickelt."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Lernen Sie die nächste Generation der Dokumentation kennen: KI-nativ, sofort einsatzbereit und für Entwickler entwickelt.
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Schnellstart" description="Setzen Sie Ihre erste Docs‑Site in wenigen Minuten mit unserer Schritt-für-Schritt-Anleitung auf" href="/de/quickstart" />

      <HeroCard filename="cli" title="CLI-Installation" description="Installieren Sie die CLI, um Ihre Dokumentation lokal zu previewen und zu entwickeln" href="/de/installation" />

      <HeroCard filename="editor" title="Webeditor" description="Nehmen Sie schnelle Updates vor und verwalten Sie Inhalte mit unserem browserbasierten Editor" href="/de/editor" />

      <HeroCard filename="components" title="Komponenten" description="Erstellen Sie umfangreiche, interaktive Dokumentation mit unseren sofort einsetzbaren Komponenten" href="/de/text" />
    </div>
  </div>
</div>
