...
<div id="enabling-support-integrations">
  ## Aktivieren von Support-Integrationen
</div>

Integrieren Sie Kundensupport-Widgets in Ihre Dokumentation. Fügen Sie das Feld `integrations` zu Ihrer Datei `docs.json` hinzu und geben Sie Ihre jeweilige App-ID an.
